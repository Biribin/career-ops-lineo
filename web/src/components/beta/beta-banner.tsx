        ...
        <div className="fixed inset-0 z-[96] flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm" role="dialog" aria-modal="true" aria-label="Signaler un bug" onClick={() => setOpen(false)}>
          <div className="w-full max-w-lg rounded-2xl border border-border bg-[var(--bg)] p-5 shadow-2xl" onClick={(e) => e.stopPropagation()}>
            ...
            <textarea
              ...
              rows={4}
              autoFocus
              placeholder="Que faisiez-vous, et qu'est-ce qui a mal tourné ?"
            ...
            <details className="mt-3 rounded-lg border border-border bg-surface/40">
              <summary className="cursor-pointer select-none px-3 py-2 text-xs font-medium text-muted">
                Exactement ce qui sera joint — relisez avant d&apos;envoyer ↓
                <span className="ml-1 font-normal text-faint">(en anglais : le ticket part chez le mainteneur du dépôt amont)</span>
              </summary>
            ...
            <p className="mt-2 flex items-start gap-1.5 text-[11px] text-faint">
              <ShieldCheck className="mt-px size-3.5 shrink-0 text-emerald-500" /> Ouvre un ticket GitHub que vous confirmez — rien n&apos;est envoyé avant votre clic. N&apos;inclut JAMAIS votre CV, votre profil, vos réponses de candidature ni les URL d&apos;offres.
            </p>
